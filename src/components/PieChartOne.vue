<template>
  <div>
    <q-card :class="$q.dark.isActive ? 'bg-dark' : ''">
      <q-card-section class="text-h6">范围一排放 </q-card-section>
      <q-separator />
      <q-card-section>
        <div
      ...
      data: [
        {
          value: props.fixburn,
          name: "固定燃烧",
          itemStyle: { color: "#9CBCE3" },
        },
        {
          value: props.movingburn,
          name: "流动燃烧",
          itemStyle: { color: "#F5C386" },
        },
      ],
    },
    {
      ...
      data: [{ value: props.emission1, name: "总排放1" }],
    },
  ],
});
onMounted(() => {
