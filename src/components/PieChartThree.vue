<template>
  <div>
    <q-card :class="$q.dark.isActive ? 'bg-dark' : ''">
      <q-card-section class="text-h6">范围三排放 </q-card-section>
      <q-separator />
      <q-card-section>
        <div
  ...
  series: [
    {
      ...
      data: [
        { value: props.commuting, name: "员工通勤",itemStyle: { color: "#B1CAA2" } },
        { value: props.travel, name: "员工差旅" ,itemStyle: { color: "#F9A490" }},
      ],
    },
    {
      name: "总量",
      ...
      data: [
      { value: props.emission3, name: '总排放3' }
      ],
    },
  ],
});
