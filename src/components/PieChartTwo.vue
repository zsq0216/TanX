<template>
  <div>
    <q-card :class="$q.dark.isActive ? 'bg-dark' : ''">
      <q-card-section class="text-h6">范围二排放 </q-card-section>
      <q-separator />
      <q-card-section>
        <div
  ...
  series: [
    {
      ...
      data: [
        { value: props.electricity, name: "购入电力",itemStyle: { color: "#C3D13C" } },
        { value: props.heating, name: "购入热力",itemStyle: { color: "#FFDE8D" }},
      ],
    },
    {
      name: "总量",
      ...
      data: [
      { value: props.emission2, name: '总排放2' }
      ],
    },
  ],
});
