...
import UserProfileForBank from "src/components/UserProfileForBank.vue";

const store = useStore();
//const username = computed(() => store.state.currentUsername);
const username = localStorage.getItem("userName");
const cur_month = computed(() => store.state.currentMonth);
const cur_year = computed(() => store.state.currentYear);
...
onMounted(() => {
  requestData.month = cur_month.value;
  requestData.year = cur_year.value;
  fetchData();
});
</script>
